...
public class TreeNodeMeshIndex {
    ...
    public double getSimilarityBetweenTwoNodes(MeshDescriptorCustom mesh1 , MeshDescriptorCustom mesh2) {
    ...
    public double getSimilarityBetweenToDocuments(List<MeshDescriptorCustom> d1, List<MeshDescriptorCustom> d2) {
